...
public class mechanic_booking extends AppCompatActivity {
    TextView name;
    TextView phno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Booking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(mechanic_booking.this, ""+checkinsertdata, Toast.LENGTH_SHORT).show();
                if(checkinsertdata==true)
                {
                    Toast.makeText(mechanic_booking.this, "NEW ENTRY Inserted", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(mechanic_booking.this,booking.class);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(mechanic_booking.this, "Not inserted", Toast.LENGTH_SHORT).show();
                }
            }
        });
