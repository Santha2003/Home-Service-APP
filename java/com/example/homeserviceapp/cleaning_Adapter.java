...
class cleaning_Adaptor extends RecyclerView.Adapter<cleaning_Adaptor.MyViewHolder> {
    private static Context context;
    private ArrayList name_id,phno_id,rating_id,amount_id;

    public cleaning_Adaptor(Context context, ArrayList name_id, ArrayList phno_id, ArrayList rating_id, ArrayList amount_id) {
    ...
    @NonNull
    @Override
    public cleaning_Adaptor.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.userentry,parent,false);
        return new MyViewHolder(v);
//        Toast.makeText(context, "Parent"+parent, Toast.LENGTH_SHORT).show();
...
//        return  null;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent=new Intent(context,cleaning_Booking.class);
            intent.putExtra("keyname",name);
            intent.putExtra("keyphno",phno);
            intent.putExtra("keyrating",rating);

            intent.putExtra("kayamount",amount);
