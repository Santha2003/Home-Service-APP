...
public class painting_Booking extends AppCompatActivity {
    TextView name;
    TextView phno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_painting_booking);
        ...
        Booking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(painting_Booking.this, ""+checkinsertdata, Toast.LENGTH_SHORT).show();
                if(checkinsertdata==true)
                {
                    Toast.makeText(painting_Booking.this, "NEW ENTRY Inserted", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(painting_Booking.this,booking.class);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(painting_Booking.this, "Not inserted", Toast.LENGTH_SHORT).show();
                }
            }
        });
