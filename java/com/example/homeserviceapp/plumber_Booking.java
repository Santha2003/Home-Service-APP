...
public class plumber_Booking extends AppCompatActivity {
    TextView name;
    TextView phno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plumber_booking);
        ...
        Booking=findViewById(R.id.booking_plum);
        ...
        Toast.makeText(plumber_Booking.this, "Before Booking", Toast.LENGTH_SHORT).show();
        Booking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(plumber_Booking.this, "After Booking", Toast.LENGTH_SHORT).show();

                String serviceTXT=service.getText().toString();
                Toast.makeText(plumber_Booking.this, ""+serviceTXT, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(plumber_Booking.this, ""+checkinsertdata, Toast.LENGTH_SHORT).show();
                if(checkinsertdata==true)
                {
                    Toast.makeText(plumber_Booking.this, "NEW ENTRY Inserted", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(plumber_Booking.this,booking.class);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(plumber_Booking.this, "Not inserted", Toast.LENGTH_SHORT).show();
                }
            }
        });
