...
class painting_Adaptor extends RecyclerView.Adapter<painting_Adaptor.MyViewHolder> {
    private static Context context;
    private ArrayList name_id,phno_id,rating_id,amount_id;

    public painting_Adaptor(Context context, ArrayList name_id, ArrayList phno_id, ArrayList rating_id, ArrayList amount_id) {
    ...
    @NonNull
    @Override
    public painting_Adaptor.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent=new Intent(context,painting_Booking.class);
