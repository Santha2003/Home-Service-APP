...
class plumber_Adaptor extends RecyclerView.Adapter<plumber_Adaptor.MyViewHolder> {
    private Context context;
    private ArrayList name_id;
    private ArrayList phno_id;
    private ArrayList rating_id;
    private ArrayList amount_id;

    public plumber_Adaptor(Context context, ArrayList name_id, ArrayList phno_id, ArrayList rating_id, ArrayList amount_id) {
    ...
    @NonNull
    @Override
    public plumber_Adaptor.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.userentry,parent,false);
        return new plumber_Adaptor.MyViewHolder(v);
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent=new Intent(context,plumber_Booking.class);
