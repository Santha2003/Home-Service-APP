...
public class electricain_Booking extends AppCompatActivity {
    TextView name;
    TextView phno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electricain_booking);
       ...
       // Toast.makeText(electricain_Booking.this, "Before Booking", Toast.LENGTH_SHORT).show();
        Booking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(electricain_Booking.this, "After Booking", Toast.LENGTH_SHORT).show();

                String serviceTXT=service.getText().toString();
                //Toast.makeText(electricain_Booking.this, ""+serviceTXT, Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(electricain_Booking.this, ""+checkinsertdata, Toast.LENGTH_SHORT).show();
                if(checkinsertdata==true)
                {
                    //Toast.makeText(electricain_Booking.this, "NEW ENTRY Inserted", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(electricain_Booking.this,booking.class);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(electricain_Booking.this, "Your choosing time is already Booking", Toast.LENGTH_SHORT).show();
                }
            }
        });
