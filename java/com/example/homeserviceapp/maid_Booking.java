...
public class maid_booking extends AppCompatActivity {
    TextView name;
    TextView phno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maid_booking);
        ...
        Booking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(maid_booking.this, ""+checkinsertdata, Toast.LENGTH_SHORT).show();
                if(checkinsertdata==true)
                {
                    Toast.makeText(maid_booking.this, "NEW ENTRY Inserted", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(maid_booking.this,booking.class);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(maid_booking.this, "Not inserted", Toast.LENGTH_SHORT).show();
                }
            }
        });
